...
pascal_sbd_dataset = dataset_base.copy({
    ...
    'train_images': '../yolact-original/data/sbd/img',
    'valid_images': '../yolact-original/data/sbd/img',
    
    'train_info': '../yolact-original/data/sbd/pascal_sbd_train.json',
    'valid_info': '../yolact-original/data/sbd/pascal_sbd_val.json',
